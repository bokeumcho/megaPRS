...
read_sumsfile(sums2file, snss2, schis2, srhos2, count, spreds, sal1, sal2, tagfile, amb, fixn, scaling2, 2, checksums);
...
gif=get_sum_stats(stags, snss, schis, srhos, count, 1, cutoff);
gif=get_sum_stats(stags, snss2, schis2, srhos2, count, 2, cutoff);
