...
//Read in details for sections, partitions or genes
...
if(mode==137||mode==138||mode==139)	//read genes
{
...
{printf("Error reading Row 1 of %s, suggesting the file has been changed since creation with \"--cut-kins\"\n\n", filename);exit(1);}
if(strcmp(readstring,"Datafiles")!=0)
{printf("Error reading Row 1 of %s, suggesting the file has been changed since creation with \"--cut-genes\"\n\n", filename);exit(1);}
