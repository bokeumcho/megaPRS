...
//set data_length and keeppreds - will only be here if use_data=1 (or use_data=6)
...
//mode=155 - calc-cors - data_length is number after filtering
//mode=156 - join-cors - use_data!=1
//mode=157 - pseudo-summaries - data_length is number after filtering
//mode=158 - pseudo-jackknife - data_length is number after filtering
...
//mode=192 - cut-gre - data_length is number after filtering
//mode=193 - cut-gre - data_length is number after filtering
//mode=194 - cut-gre - data_length is number after filtering
