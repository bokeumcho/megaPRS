...
(void)read_data_fly(datafile, dtype, data, NULL, num_samples_use, keepsamps, 0, data_length, keeppreds_use, datainputgz, 0, num_samples, num_preds, genskip, genheaders, genprobs, missingvalue, -9999, -9999, nonsnp, maxthreads);
stand_data(data, centres, mults, sqdevs, num_samples_use, data_length, missingvalue, power, strcmp(centresfile,"blank")!=0, hwestand, weights, 1, preds);
...
write_kins(outfile, NULL, kins_single, num_samples_use, ids1, ids2, 1, preds, keeppreds_use, centres, mults, weights, al1, al2, data_length, datafile, power, kingz, kinraw, 1);
