...
//consider top count3 out of count2 stats
{
...
if(wcount>5){printf("In total, problems with %d out of %d predictors\n", wcount, count3);}
if(wcount>0){printf("\n");}
...
//int nm_optim(double *alpha, double *beta, double S, double T, double cut)
int nm_optim2(double *alpha, double *beta, double *stats, int count2, int count3)
{
