...
if(flag==0)
{write_kins(outfile, kins, NULL, num_samples_use, ids1, ids2, 1, kpreds, kindex, kcentres, kmults, kweights, kal1, kal2, count, readstring2, power, kingz, kinraw, 1);}
else
{write_kins(outfile, kins, NULL, num_samples_use, ids1, ids2, 1, kpreds, kindex, kcentres, kmults, kweights, kal1, kal2, count, NULL, power, kingz, kinraw, 1);}
