...
{kins_single[(size_t)i2*num_samples_use+i]=0;kins_single[(size_t)i*num_samples_use+i2]=0;count++;}
}
}
if(count==0){printf("Error, there are no off-diagonal allelic correlations less than %.6f\n\n", cutoff);exit(1);}
printf("There are %d off-diagonal allelic correlations less than %.6f\n\n", count, cutoff);

sprintf(filename,"%s.trun",outfile);
write_kins(filename, NULL, kins_single, num_samples_use, ids1, ids2, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -9999, NULL, -9999, kingz, kinraw, 3);
...
{kins_single[(size_t)i2*num_samples_use+i]=1;kins_single[(size_t)i*num_samples_use+i2]=1;count++;}
}
}
if(count==0){printf("Error, there are no off-diagonal allelic correlations at least %.6f\n\n", cutoff);exit(1);}
printf("There are %d off-diagonal allelic correlations at least %.6f\n\n", count, cutoff);

sprintf(filename2,"%s.cenv",outfile);
write_kins(filename2, NULL, kins_single, num_samples_use, ids1, ids2, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -9999, NULL, -9999, kingz, kinraw, 3);
...
write_kins(filename, kins, NULL, num_samples_use, ids1, ids2, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -9999, NULL, -9999, kingz, kinraw, 3);
...
write_kins(filename2, kins2, NULL, num_samples_use, ids1, ids2, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -9999, NULL, -9999, kingz, kinraw, 3);
...
write_kins(outfile, NULL, kins_single, num_samples_use, ids1, ids2, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -9999, NULL, -9999, kingz, kinraw, 3);
...
kins_single[(size_t)i2*num_samples_use+i]*=value;
}
}
...
write_kins(filename, NULL, kins_single2, num_samples_use, ids1, ids2, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -9999, NULL, -9999, kingz, kinraw, 3);

for(i2=0;i2<num_samples_use;i2++)
{
for(i=0;i<num_samples_use;i++){kins_single2[(size_t)i2*num_samples_use+i]=0;}
kins_single2[(size_t)i2*num_samples_use+i2]=Z[i2+j*num_samples_use]*Z[i2+j*num_samples_use];
}
...
{printf("Error writing to %s; check you have permission to write and that there does not exist a folder with this name\n\n",filename2);exit(1);}
fprintf(output2, "%s\n", kinstems[0]);
for(j=0;j<num_fixed;j++){fprintf(output2, "%s.Genetic%d\n", outfile, j+1);}
for(j=0;j<num_fixed;j++){fprintf(output2, "%s.Noise%d\n", outfile, j+1);}
fclose(output2);
...
fprintf(output2, "%s\n", kinstems[0]);
for(j=0;j<num_fixed;j++){fprintf(output2, "%s.Genetic%d\n", outfile, j+1);}
for(j=0;j<num_fixed-1;j++){fprintf(output2, "%s.Noise%d\n", outfile, j+1);}
fclose(output2);
