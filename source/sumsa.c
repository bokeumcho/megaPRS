...
{solve_sums(stats, likes, cohers, influs, num_parts, gcon, cept, num_blocks, count, ncv, cvindex, cvexps, stags, svars, ssums, snss, schis, parttype, tol, maxiter, chisol, 0, filename);}
...
solve_sums(stats2, NULL, NULL, NULL, num_reds, gcon, cept, -9999, count, ncv, cvindex, NULL, stags, svars2, ssums2, snss, schis, parttype, tol, maxiter, chisol, 1, filename);
...
solve_sums(stats, likes, cohers, influs, num_parts, gcon, cept, num_blocks, count, ncv, cvindex, cvexps, stags, svars, ssums, snss, schis, parttype, tol, maxiter, chisol, 2, filename);
}
...
solve_sums(stats, likes, NULL, influs, num_parts, gcon, cept, -9999, count, ncv, cvindex, cvexps, stags, svars, ssums, snss, schis, parttype, tol, maxiter, chisol, 3, filename);
...
{solve_sums(stats, likes, cohers, influs, num_parts, gcon, cept, num_blocks, count, ncv, cvindex, cvexps, stags, svars, ssums, snss, schis, parttype, tol, maxiter, chisol, 4, filename);}
}
...
{solve_sums(stats, likes, cohers, influs, divide, gcon, cept, num_blocks, count, ncv, cvindex, cvexps, stags, svars2, ssums2, snss, schis, 1, tol, maxiter, chisol, 0, filename);}
...
solve_sums(stats, likes, cohers, influs, divide, gcon, cept, num_blocks, count, ncv, cvindex, cvexps, stags, svars2, ssums2, snss, schis, 1, tol, maxiter, chisol, 5, filename);}
...
fprintf(output4,"%.6f %.6f %.6f %.6f %.6f\n", stats[total+1+q]/stats[total], stats[total+1+q+2*(total+1+num_parts_use)], ssums_use[q][num_parts_use+1], stats[total+1+q]/stats[total]/ssums_use[q][num_parts_use+1], stats[total+1+q+2*(total+1+num_parts_use)]/ssums_use[q][num_parts_use+1]);
}
fclose(output4);
...
free(stats);free(likes);free(cohers);free(influs);
