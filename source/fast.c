...
{reg_covar_log(Y, Z, num_samples_use, num_covars, num_tops, thetas, thetasds, thetapvas, Yadj, &covher, &topher, prev, 0.0001, 20);}
...
//get contribution to traces - do all kinships at once (a bit wasteful if have continuous partitions)
token=end-start;
alpha=1.0;beta=1.0;
