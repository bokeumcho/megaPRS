...
double adv_reml(int ns, int num_fixed, int num_regs, double *Y, double *Z, double *U, double *E, double *kintraces, double *X, int Xtotal, double Xsum, double *stats, double *vstarts, double tol, int maxiter)
{
int i, j, j2, k, k2, r, g, count, token, one=1, info;
...
int *ipiv, lwork;
double *ZTVY=NULL;
float wkopt_single, *work_single=NULL, alpha_single, beta_single, *R_single=NULL, **KR_single=NULL, *V_single=NULL, *RHS_single=NULL;
float *PY_single=NULL, *KPY_single=NULL, *RHS2_single=NULL, *kins_single=NULL;
...
if(count==maxiter)
{
printf("\nWarning, REML failed to converge within %d iterations; if this happens many times, consider using \"--max-iter\" and/or \"--tolerance\" to change the iteration limit and tolerance", maxiter);
break;
}
