...
if(dtype==1||dtype==3||dtype==4)	//can read in parallel
{
...
if(dtype==1)
{read_bed_fly(datafile, data+(size_t)(threadstart-start)*num_samples_use, num_samples_use, keepsamps, threadstart, threadend, keeppreds_use, num_samples, num_preds, missingvalue);}
...
//type=0 - just calc centre, mult and sqdev
...
if(strcmp(bpredfile,"blank")!=0||strcmp(onesnp,"blank")!=0||onechr!=-9999||strcmp(onesnp,"blank")!=0)
{printf("\n");}
